...
export default async function OrganizationDashboard({ params }: { params: { orgSlug: string } }) {
  ...
  const checklistItems = [
    {
      ...
      href: `/app/${organization.slug}/links`,
    },
    {
      id: "invited-team",
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href={`/app/${organization.slug}/links`}>Manage links</Link>
            </Button>
          </CardHeader>
          <CardContent>
